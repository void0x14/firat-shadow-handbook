...
- [x] ShadowSession: HMAC imzali, server-side doğrulamalı guvenli oturum mekanizmasi.
- [x] IP bazlı rate limiting ve guvenlik basliklari (CSP, XSS korumasi).
- [x] Serde bagimliligi olmadan manuel JSON parsing ve query string handling.
- [x] Hexagonal Mimari: Domain, Application ve Infrastructure katmanlarinin ayrıştırılması.
...
- [ ] Otomatik ders kayit indirme ve transcoding asistanı.
